      ...
      <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8">
        <div className="grid lg:grid-cols-[1.05fr_0.95fr] items-center gap-12">
          ...
          <div>
            ...
            {/* CTA */}
            <div className="mt-6">
              <Button asChild size="lg" trackingId="brand-hero-know-more" trackingLocation="brand-hero">
          ...
          <div className="relative">
            ...
            >
              <div className="relative mx-auto w-[18rem] sm:w-[20rem]">
                {/* Phone frame */}
                <svg viewBox="0 0 366 729" role="img" className="mx-auto w-full drop-shadow-xl">
                  ...
                  <foreignObject width="316" height="684" transform="translate(24 24)" clipPath="url(#phone-clip)">
                    <img src="/phone-brand.svg" alt="Crafy app" />
                  </foreignObject>
                </svg>
              </div>
            </motion.div>
