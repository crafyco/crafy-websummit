...
export default function NewsletterSection() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-[#FAF7F7] mx-6 my-16 sm:mx-24 sm:my-24 px-6 py-24 shadow-2xl rounded-3xl sm:px-24 xl:py-32 border border-[#E5E7EB]">
      <div
        className="absolute -bottom-full -left-1/2 -z-10 transform-gpu blur-3xl"
        aria-hidden="true"
      >
        <div className="aspect-square w-[600px] bg-gradient-to-br from-[#ED393D]/70 to-[#CB2C30]/0 opacity-20 sm:w-[1024px] sm:opacity-50" />
      </div>
      <div
        className="absolute -top-full -right-1/2 -z-10 transform-gpu blur-3xl"
        aria-hidden="true"
      >
        <div className="aspect-square w-[600px] bg-gradient-to-tl from-[#ED393D]/70 to-[#CB2C30]/0 opacity-20 sm:w-[1024px] sm:opacity-50" />
      </div>
      <div
        className="absolute top-0 left-0 -z-10 transform-gpu blur-3xl"
        aria-hidden="true"
      >
        <div className="aspect-square w-[600px] bg-gradient-to-br from-[#393CED]/70 to-[#CB2C30]/0 opacity-10 sm:w-[1024px] sm:opacity-30" />
      </div>
      ...
      <div>
        ...
        <p className="mx-auto mt-6 max-w-lg text-center font-raleway text-lg text-[#4B5563] sm:text-[#000000]">
          Stay updated with the latest news! Sign up with your email to receive
