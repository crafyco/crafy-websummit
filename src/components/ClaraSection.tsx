...
const cards = {
  brand: [
    ...
    {
      title: 'Time-saver',
      description: 'Ditch the spreadsheets and manual follow-ups, let Clara help you. Manage campaigns without the headache.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    {
      title: 'Effective',
      description: 'Get big-brand results without the big-brand budget. Creator marketing is one of the most cost-effective ways to grow.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
